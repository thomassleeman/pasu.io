...
import journaling from "@/components/design/landingPage/images/journaling-page-example.jpg";
  ...
  return (
    <div className="px-4 py-5 sm:p-6">
      <div className="relative">
        ...
        <Image
          alt="Example image of a journaling for insight exercise."
          src={journaling}
          width={500}
          height={500}
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 mx-4 mb-4 rounded-lg border border-gray-300/50 bg-white/30 p-4 shadow-lg backdrop-blur-xl">
          <p className=" max-w-lg text-sm text-gray-600">
            ...
            Resources to combat burnout at work.
          </p>
        </div>
        {/* </div> */}
